    ...
    <section className="py-20 pb-32 relative z-10">
      <div className="container mx-auto px-4 text-center">
        <motion.h2 
          ...
          viewport={{ once: true }}
          className="text-3xl font-bold mb-12 bg-clip-text text-transparent bg-gradient-to-r from-cyan-400 to-purple-600"
        >
          Let's Connect
        </motion.h2>
          ...
          {contacts.map((contact, index) => (
            contact.value && (
              <motion.a
                ...
                className={`p-4 rounded-xl bg-white/5 backdrop-blur-sm border border-white/10 text-gray-400 transition-all duration-300 ${contact.color} ${contact.bg} hover:-translate-y-2 hover:shadow-[0_0_20px_rgba(255,255,255,0.1)]`}
              >
                {contact.icon}
